...
int main()
{
    ...
    int n;
    cout << "type in number of iterations n = ?" << endl;
    cin >> n;
...
/*
 * 10
gaussian_elim t = 2e-05 s
gaussian_special t = 3e-06 s
solvethri t = 0.000161 s total time of 8 CPUs
*/

/*
100
gaussian_elim t = 0.000182 s
gaussian_special t = 1.2e-05 s
solvethri t = 0.001698 s total time of 8 CPUs
*/

/*
 * 1000
gaussian_elim t = 0.000244 s
gaussian_special t = 8.7e-05 s
solvethri t = 0.080743 s total time of 8 CPUs
*/
...
/*
 * 100000
gaussian_elim t = 0.014378 s
gaussian_special t = 0.004838 s
*/
