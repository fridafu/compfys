...
files = ['Dalpha2_lambda0_N1000.dat', 'Ealpha2_lambda0_gamma_1_N1000.dat','Ealpha2_lambda0_gamma_2_N1000.dat','Ealpha2_lambda0_gamma_3_N1000.dat','Ealpha2_lambda0_gamma_4_N1000.dat']
...
norm = sum(X1['counts'])
figure()
plot(X1['m'], X1['counts']/norm, 'r')
hold('on')
plot(X2['m'], X2['counts']/norm, 'g')
hold('on')
plot(X3['m'], X3['counts']/norm, 'b')
hold('on')
plot(X4['m'], X4['counts']/norm, 'k')
hold('on')
plot(X5['m'], X5['counts']/norm, 'm')
